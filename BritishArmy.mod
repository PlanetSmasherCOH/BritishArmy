...
<Document xmlns:i="http://www.w3.org/2001/XMLSchema-instance" xmlns="http://schemas.datacontract.org/2004/07/RelicCore.ModProject">
				...
				<d2p1:anyType i:type="Folder">
					<Children>
						<d2p1:anyType i:type="BurnAttributes">
							<RelativeName>BritishArmy.xml</RelativeName>
						</d2p1:anyType>
					</Children>
		...
		<d2p1:anyType i:type="TableOfContents">
			...
			<Children>
				<d2p1:anyType i:type="BurnModInfo">
					<Dependencies />
					<Description>Complete redesign of the British faction with linear teching and no gimmicks.</Description>
					<Hidden>false</Hidden>
	...
	<Guid>df1550df-a842-4463-bcf2-9079befc75fb</Guid>
	<IsExpanded>false</IsExpanded>
